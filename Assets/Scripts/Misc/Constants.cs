...
public static class Constants : object {
    ...
    public static Vector3 SMALL_PIZZA_SCALE = new Vector3(1f, 1f, 1f);
    public static Vector3 MEDIUM_PIZZA_SCALE = new Vector3(1f, 1f, 1f);
    public static Vector3 LARGE_PIZZA_SCALE = new Vector3(1f, 1f, 1f);
